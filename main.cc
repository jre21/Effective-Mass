...
int main(int argc, char **argv)
{
  ...
  double eta = 1.07, rb = 0.98, r1 = 0.68;
  ...
  printf("old params\n");
  ham.set_crystal_parameter(_A1, 6.36*eta);
  ham.set_crystal_parameter(_A2, 0.51*eta);
  ham.set_crystal_parameter(_A3, -5.85*eta);
  ham.set_crystal_parameter(_A4, 2.92*eta);
  ham.set_crystal_parameter(_A5, 2.60*eta);
  ham.set_crystal_parameter(_A6, 3.21*eta);
  ham.set_crystal_parameter(_d1, -42);
  ham.set_crystal_parameter(_d2, -6.3);
  ham.set_crystal_parameter(_d3, -6.3);
  ham.set_crystal_parameter(_dielectric, 9.8);
  printf("Coulomb_GaN: %f\n", ham.get_eval(0));
